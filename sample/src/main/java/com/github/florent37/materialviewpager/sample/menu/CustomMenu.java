package com.github.florent37.materialviewpager.sample.menu;
        ...
        for (int i=0; i < mRows; i++) {
    		...
    		for (int j=0; j< divisor; j++) {
    			...
    			Typeface face = Typeface.createFromAsset(mContext.getAssets(),
						"font/"+com.github.florent37.materialviewpager.sample.attrib.attribute.font_menu);
    			tv.setTypeface(face);
    			tv.setTextColor(com.github.florent37.materialviewpager.sample.attrib.attribute.menu_font_color);
    			tv.setText(cmi.getCaption());
    			tv.setTextSize(com.github.florent37.materialviewpager.sample.attrib.attribute.menu_font_size);
